...
borealforest <- metR::ReadNetCDF("arctic_data/spatial_means/GPP_MODIS_OD17A3HGF.061/MOD17A3HGF.061_gpp_borealforest.nc",
                                 out = "data.frame")

tundra <- metR::ReadNetCDF("arctic_data/spatial_means/GPP_MODIS_OD17A3HGF.061/MOD17A3HGF.061_gpp_tundra.nc", 
                           out = "data.frame")

arctic <- metR::ReadNetCDF("arctic_data/spatial_means/GPP_MODIS_OD17A3HGF.061/MOD17A3HGF.061_gpp_arctic.nc", 
                           out = "data.frame")
